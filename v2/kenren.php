...
<head>
  ...
  <meta name="keywords" content="予定,高知県連盟,高知地区,居合,土佐直伝英信流">
...
<div class="container text-center">
  ...
  <div class="row">
    ...
    <div class="col-xs-6 text-right">
      <h2>
        <small>
          <a href="kenren.php?year=<?= $lastYear ?>"><span
              class="glyphicon glyphicon-chevron-left"></span></a>
            <?= $year ?>年度
          <a href="kenren.php?year=<?= $nextYear ?>"><span
  ...
  <table class="table table-bordered table-striped">
    ...
    $calendarId = '8lopgevlqtht7bv3is4udhhu7g@group.calendar.google.com';
  ...
  <p>この予定表はGoogleカレンダーから作成しています。<a
      href="https://calendar.google.com/calendar/embed?src=8lopgevlqtht7bv3is4udhhu7g%40group.calendar.google.com&ctz=Asia/Tokyo"><span
